...
public class TracksResponse {
   ...
   */
  @NonNull
  private List<TracksDefaultModel> data;
  ...
  public static class TracksResponseBuilder {

    private JsonNullable<Object> debug = JsonNullable.undefined();

    @JsonProperty("debug")
    public TracksResponseBuilder debug(Object value) {
    ...
    @JsonProperty("explain")
    public TracksResponseBuilder explain(Object value) {
