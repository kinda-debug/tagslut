...
/**
 * Exception class for API errors with structured HttpValidationError error details.
 * Extends ApiError to provide typed access to the error response model.
 * Thrown when the API returns an error response that can be deserialized to HttpValidationError.
 */
@Getter
public class HttpValidationErrorException extends ApiError {
   ...
   */
  public HttpValidationErrorException(
