...
GDRIVE_DIR="/Users/georgeskhawam/Library/CloudStorage/GoogleDrive-khawam.georges@gmail.com/My Drive/tagslut"
GDRIVE_OUT="$GDRIVE_DIR/tagslut_context_bundle.zip"
