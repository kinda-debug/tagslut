...
```bash
python3 tools/integrity/scan.py /Volumes/RECOVERY_TARGET/Root/FINAL_LIBRARY --db artifacts/db/music.db --library recovery --incremental --progress
```
