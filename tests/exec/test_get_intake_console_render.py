...
def test_plain_report_is_stable_and_auditable(tmp_path: Path) -> None:
    ...
    for line in [
        ...
        "  Batch root    /Volumes/MUSIC/staging/tidal\n",
        "  DB            /tmp/music.db\n",
        ...
        "Downloaded First Track  16-bit, 44.1 kHz /Volumes/MUSIC/staging/tidal/Alpha/Album A\n",
        "Tagged:  0\n",
...
def test_stage_header_gating_ignores_non_run_totals() -> None:
    ...
    for line in [
        ...
        "  Batch root    /Volumes/MUSIC/staging/bpdl\n",
        "  DB            /tmp/music.db\n",
        "  Library root  /Volumes/MUSIC/MASTER_LIBRARY\n",
