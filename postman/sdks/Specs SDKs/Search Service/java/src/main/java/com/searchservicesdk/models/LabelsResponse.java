...
public class LabelsResponse {
   ...
   */
  @NonNull
  private List<LabelsDefaultModel> data;
  ...
  public static class LabelsResponseBuilder {

    private JsonNullable<Object> debug = JsonNullable.undefined();

    @JsonProperty("debug")
    public LabelsResponseBuilder debug(Object value) {
    ...
    @JsonProperty("explain")
    public LabelsResponseBuilder explain(Object value) {
