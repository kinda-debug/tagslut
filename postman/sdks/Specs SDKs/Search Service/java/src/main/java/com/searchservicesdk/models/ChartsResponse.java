...
public class ChartsResponse {
   ...
   */
  @NonNull
  private List<ChartsDefaultModel> data;
  ...
  public static class ChartsResponseBuilder {

    private JsonNullable<Object> debug = JsonNullable.undefined();

    @JsonProperty("debug")
    public ChartsResponseBuilder debug(Object value) {
    ...
    @JsonProperty("explain")
    public ChartsResponseBuilder explain(Object value) {
