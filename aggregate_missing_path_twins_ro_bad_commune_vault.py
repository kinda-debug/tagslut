#!/usr/bin/env python3
# Proves: deterministic aggregation of checksum-match CSVs with existence-aware filtering for /Volumes/bad, /Volumes/COMMUNE, /Volumes/Vault.
...
OUT_MATCHES = BASE / "missing_paths_RECOVERY_TARGET_checksum_matches_ro_bad_commune_vault.csv"
OUT_BY_PREFIX = BASE / "missing_paths_checksum_twins_by_prefix_ro_bad_commune_vault.csv"
OUT_COLLAPSE = BASE / "missing_paths_checksum_twin_collapse_ro_bad_commune_vault.csv"
OUT_ORPHANS = BASE / "missing_paths_without_any_checksum_twin_ro_bad_commune_vault.csv"
...
EXISTENCE_FILES = [
    ...
    BASE / "fs_existence_ro_Volumes__Vault__RC2.csv",
    BASE / "fs_existence_ro_Volumes__Vault__RECOVERED_TRASH.csv",
    BASE / "fs_existence_ro_Volumes__Vault__Root.csv",
    BASE / "fs_existence_ro_Volumes__Vault__Vault.csv",
]

CONFIRMED_PREFIXES = ("/Volumes/bad/", "/Volumes/COMMUNE/", "/Volumes/Vault/")
...
# Matches in confirmed prefixes are only counted when match_exists == 1.
dedup_triplets = set()
prefix_to_paths = {}
prefix_to_checksums = {}
prefix_to_rows = {}
...
print("/Volumes/bad, /Volumes/COMMUNE, /Volumes/Vault matches counted only when match_exists == 1")
