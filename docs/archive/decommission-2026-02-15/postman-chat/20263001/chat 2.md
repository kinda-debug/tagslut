...
DB_PATH = "<TAGSLLUT_REPO>/
    EPOCH_2026-01-24/music.db"
NDJSON_PATH = "<TAGSLLUT_REPO>/
...
DB_PATH = os.environ.get("MUSIC_DB", "<USER_HOME>/
...
# Recovery mode
python3 cli.py recovery --db "<USER_HOME>/
    Projects/tagslut/EPOCH_2026-01-24/music.db"
