...
3. **Temporary patch artifacts**
   ...
   - `patches/patch.patch`, `patches/patch_missing_files.txt`, `patches/patch_paths_full.txt` — Patch lists that appear to be migration scaffolding; retire after confirming no active workflows depend on them.
