...
echo "-----------------------------------------------------"
echo ""
echo "# Canonical product CLI:"
echo "poetry run tagslut --help"
echo ""
...
echo "ts-get <url> --dj"
echo ""
echo "# Local staged intake from an already-downloaded directory:"
echo "poetry run tagslut get /path/to/dir --tag"
echo ""
echo "# Process whatever is still in staging:"
echo "tools/ts-stage"
echo ""
echo "# Launch SpotiFLAC-Next with repo-local logging:"
echo "tools/spotiflac-next"
echo ""
echo "# Downloader env for ts-get:"
echo "#   Beatport -> repo-local helper by default; override with BEATPORTDL_CMD or BEATPORTDL_BIN if needed"
echo "#   Qobuz    -> STREAMRIP_CONFIG is required; STREAMRIP_CMD is an optional override"
echo "#   SpotiFLAC-Next -> logs to artifacts/logs/spotiflacnext by default; override with SPOTIFLAC_NEXT_LOG_ROOT"
echo ""
