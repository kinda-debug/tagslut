...
## Root
- `README.md`, `CHANGELOG.md`, `CONTRIBUTING.md`, `LICENSE` — Project documentation and metadata.
- `docs/` — Operator docs, plans, and status notes (including `docs/USAGE.md`).
...
- `docs/patches/patches/` — Patch lists used during migrations.
...
- `scripts/` — Maintenance helpers; operational entrypoints live under `scripts/ops/`.
- `tools/` — Importable utilities; operational entrypoints live under `tools/ops/`.
